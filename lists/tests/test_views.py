...
class NewItemTest(TestCase):
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(f'{settings.BASE_URL}/lists/{correct_list.id}/add_item', data = {'item_text': 'A new item for an existing list'})
    ...
    def test_redirects_to_list_view(self):
        other_list = List.objects.create()
        correct_list = List.objects.create()
        response  = self.client.post(f'{settings.BASE_URL}/lists/{correct_list.id}/add_item', data = {'item_text': 'A new item for an existing list'})
